...
From the 'README.txt' supplied with the original data:
...
For a full description of the experiment refer to:
...
The following information is taken directly from the 'features_info.txt' supplied with the original dataset: 
